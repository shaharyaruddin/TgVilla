          ...
          >
            ...
            <div className="relative z-10 backdrop-blur-3xl bg-white/20 p-8 text-center">
              ...
              <p ref={leftSubtextRef} className="text-white mb-4">
                by{" "}
                <span className="text-[#003B95] font-bold text-2xl font-playfair">
                  Booking.com
                </span>
              </p>
              <p
                ref={leftTextRef}
                className="text-white mb-6 text-lg font-playfair"
              >
          ...
          >
            ...
            <div className="relative z-10 backdrop-blur-3xl bg-white/20 p-8 text-center">
              ...
              <p ref={rightSubtextRef} className="text-white mb-4">
                by{" "}
                <span className="text-[#FF607D] font-bold text-2xl font-playfair">
                  Airbnb.com
                </span>
              </p>
              <p
              ...
              >
                ...
                properties consistently rank among the highest-rated
                accommodations.
              </p>
              <Link href="/bookings">
                <button
