...
const FirstSide = () => {
  return (
    <div className="w-full h-full absolute font-playfair   translate-z-[7.4rem] max-md:translate-z-[15rem] max-sm:translate-z-[27vh] px-10 border border-primary  border-b-0 border-t-0 border-l-0 border-r-0 ">
