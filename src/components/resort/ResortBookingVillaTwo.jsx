...
const ResortBookingVillaTwo = () => {
  const images = [
    { src: "/assets/images/bedroomVilla/bedroom1.jpg", alt: "2 Bedroom Villa" },
      ...
      { src: "/assets/images/bedroomVilla/bedroom5.jpg", alt: "2 Bedroom Villa" },
  ...
  return (
    <div className="w-full min-h-screen px-20 max-xl:px-10 max-md:px-5 flex flex-col bg-[#EBE7DC] space-y-5 pt-10">
      <h2 className="text-6xl font-[600] text-[#514941] font-cormorant max-md:text-4xl ">
        2 Bedroom Villa
      </h2>
      <div className="grid grid-cols-6 gap-2 mt-10 max-md:mt-5 max-md:grid-cols-2 max-sm:grid-cols-1">
