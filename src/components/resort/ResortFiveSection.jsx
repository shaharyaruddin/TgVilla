...
const ResortFiveSection = () => {
  ...
  return (
    <div className="space-y-3 px-20 max-xl:px-10 max-md:px-0 max-md:text-center text-[#514941] mt-10">
      <div className="px-5">
        ...
        <p className="text-xl max-md:text-sm">
          ...
          Villas, where high-end interiors, stunning outdoor spaces, and private
