...
const ResortTopSection = () => {
  ...
  return (
    ...
    >
      <h3 className="text-[12vw] max-xl:text-[15vw] max-md:text-[17vw] uppercase font-[600] text-transparent bg-clip-text bg-[url(/assets/images/posters/text-residence.jpg)] bg-center">
        tg resort
      </h3>
    </div>
  );
